...
const GiftBoxFull = ({ lidControls }: { lidControls: AnimControls }) => (
  <svg viewBox="0 0 300 340" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
    style={{ width: "clamp(220px, 30vw, 380px)", height: "auto", overflow: "visible" }}>
    <defs>
      <pattern id="zbBodyB" patternUnits="userSpaceOnUse" width="28" height="28" patternTransform="rotate(-42)">
        <rect width="28" height="28" fill="#f5f3ee"/><rect width="14" height="28" fill="#1a1a1a"/>
      </pattern>
      <pattern id="zbLidB" patternUnits="userSpaceOnUse" width="20" height="20" patternTransform="rotate(-42)">
        <rect width="20" height="20" fill="#f5f3ee"/><rect width="10" height="20" fill="#1a1a1a"/>
      </pattern>
      <linearGradient id="goldRibbonB" x1="0" y1="0" x2="1" y2="0">
        <stop offset="0%" stopColor="#a27b42"/><stop offset="30%" stopColor="#c8a96f"/>
        <stop offset="55%" stopColor="#e9d7a4"/><stop offset="75%" stopColor="#c8a96f"/><stop offset="100%" stopColor="#b89456"/>
      </linearGradient>
      <linearGradient id="goldBowB" x1="0" y1="0" x2="1" y2="1">
        <stop offset="0%" stopColor="#e9d7a4"/><stop offset="45%" stopColor="#c8a96f"/><stop offset="100%" stopColor="#a27b42"/>
      </linearGradient>
      <linearGradient id="goldWashB" x1="0" y1="0" x2="1" y2="1">
        <stop offset="0%" stopColor="#e9d7a4" stopOpacity="0.18"/><stop offset="100%" stopColor="#a27b42" stopOpacity="0.10"/>
      </linearGradient>
      <linearGradient id="bodySheenB" x1="0" y1="0" x2="1" y2="1">
        <stop offset="0%" stopColor="rgba(255,255,255,0.25)"/><stop offset="100%" stopColor="rgba(0,0,0,0.12)"/>
      </linearGradient>
      <linearGradient id="lidSheenB" x1="0" y1="0" x2="0" y2="1">
        <stop offset="0%" stopColor="rgba(255,255,255,0.35)"/><stop offset="100%" stopColor="rgba(255,255,255,0)"/>
      </linearGradient>
      <clipPath id="cpBodyB"><rect x="20" y="160" width="260" height="160" rx="8"/></clipPath>
      <clipPath id="cpLidB"><rect x="10" y="130" width="280" height="38" rx="6"/></clipPath>
    </defs>
    <rect x="20" y="160" width="260" height="160" rx="8" fill="#f5f3ee"/>
    <rect x="20" y="160" width="260" height="160" rx="8" fill="url(#zbBodyB)" clipPath="url(#cpBodyB)"/>
    <rect x="20" y="160" width="260" height="160" rx="8" fill="url(#goldWashB)"/>
    <rect x="20" y="160" width="260" height="160" rx="8" fill="url(#bodySheenB)"/>
    <rect x="20" y="160" width="260" height="160" rx="8" fill="none" stroke="#1a1a1a" strokeWidth="2"/>
    <rect x="133" y="160" width="34" height="160" fill="url(#goldRibbonB)"/>
    ...
    <motion.g animate={lidControls} style={{ originX: "150px", originY: "149px" }}>
      <path d="M150 135 C132 120 95 93 58 89 C38 87 30 101 42 111 C56 122 108 125 150 135Z" fill="url(#goldBowB)"/>
      <path d="M150 135 C132 120 95 93 58 89 C38 87 30 101 42 111 C56 122 108 125 150 135Z" fill="rgba(0,0,0,0.08)"/>
      <path d="M150 134 C136 123 104 101 72 95 C60 92 52 97 56 103" fill="none" stroke="rgba(255,255,255,0.35)" strokeWidth="3" strokeLinecap="round"/>
      <path d="M150 135 C168 120 205 93 242 89 C262 87 270 101 258 111 C244 122 192 125 150 135Z" fill="url(#goldBowB)"/>
      <path d="M150 135 C168 120 205 93 242 89 C262 87 270 101 258 111 C244 122 192 125 150 135Z" fill="rgba(0,0,0,0.08)"/>
      <path d="M150 134 C164 123 196 101 228 95 C240 92 248 97 244 103" fill="none" stroke="rgba(255,255,255,0.35)" strokeWidth="3" strokeLinecap="round"/>
      <rect x="10" y="130" width="280" height="38" rx="6" fill="#f5f3ee"/>
      <rect x="10" y="130" width="280" height="38" rx="6" fill="url(#zbLidB)" clipPath="url(#cpLidB)"/>
      <rect x="10" y="130" width="280" height="38" rx="6" fill="url(#goldWashB)"/>
      <rect x="10" y="130" width="280" height="38" rx="6" fill="url(#lidSheenB)"/>
      <rect x="10" y="130" width="280" height="38" rx="6" fill="none" stroke="#1a1a1a" strokeWidth="2"/>
      <rect x="10" y="142" width="280" height="14" fill="url(#goldRibbonB)"/>
      <rect x="10" y="146" width="280" height="5" fill="rgba(255,255,255,0.22)"/>
      <rect x="133" y="130" width="34" height="38" fill="url(#goldRibbonB)"/>
    </motion.g>
  </svg>
);
...
export default function Landing() {
  ...
  useEffect(() => {
    const trigger = async () => {
      ...
      setConfetti(Array.from({ length: 55 }).map((_, i) => ({
        id: i, left: `${20 + Math.random() * 60}%`, size: Math.random() * 12 + 7,
      ...
      lidCtrl.start({ y: -600, rotate: -8, transition: { duration: 0.85, ease: [0.45, 0, 0.55, 1] } });
  ...
  return (
    <motion.div exit={{ opacity: 0 }} transition={{ duration: 0.5 }} style={{
      ...
      {/* ── VB: Inset zebra picture-frame — four sides, cream interior ── */}
      {/* Top rail */}
      ...
      <div style={{ position: "relative", zIndex: 2, display: "flex", flexDirection: "column", alignItems: "center", marginBottom: "9rem" }}>
        {confetti.map((p) => (
          <motion.div key={p.id} initial={{ opacity: 0, y: 0, x: 0, rotate: 0 }}
            ...
            style={{ position: "absolute", top: "63%", left: p.left, width: p.size, height: p.size * 0.55, backgroundColor: p.color, borderRadius: 2, pointerEvents: "none", zIndex: 20 }} />
        ))}
